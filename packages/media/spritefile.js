...
class SpriteMediaFile extends MediaFile {
    ...
    unpack() {
        const mediaClass = this.mediaClass;
        if (mediaClass == MediaClassId.SPRITES_SPRITEPAD) {
            this.unpackSpritePad();
        } else if (mediaClass == MediaClassId.SPRITES_SPRITEMATE) {
            this.unpackSpriteMate();
        }
    }
...
SpriteMediaFile.ClassName = MediaClassId.SPRITES;
