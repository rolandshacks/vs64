...
class DwarfTag extends DwarfItem {
    ...
    #deserialize(deserializer) {
        ...
        this.tagName = Lang.getEnumKey(DwarfTagIds, this.id);
        ...
        if (infoStruct.attributes) {
            ...
            for (const attributeSpec of infoStruct.attributes) {
                ...
                if (STORE_TEMP_VERBOSE_DEBUG_INFO) {
                    attribute.name = Lang.getEnumKey(DwarfAttributeIds, attributeSpec.name);
                    attribute.formCode = attributeSpec.formCode;
                    attribute.formCodeName = Lang.getEnumKey(DwarfFormCodes, attributeSpec.formCode);
                    //console.log("(" + name + " : " + Lang.getEnumKey(DwarfFormCodes, attributeSpec.formCode) + ")");
